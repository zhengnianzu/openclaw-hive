...
# ---------------------------------------------------------------------------
def _setup_clean_log(output_path: str) -> None:
    """Set up a clean log file (no timestamp) under the task output directory."""
    clean_log_path = os.path.join(output_path, "hive_clean.log")
    os.makedirs(output_path, exist_ok=True)
    handler = logging.FileHandler(clean_log_path, mode="a")
...
def main() -> None:
    ...
    _setup_clean_log(task_config.task_output_path)
